...
public class MainTest extends Main {
	...
	@Resource
	private static IMessageProviderUtil messageProvider;//●ここの命名がProviderとか付いて、違うから、自動バインディングできないのかな？
	...
	public static void setUpClass() throws Exception {
		...
		messageProvider = SingletonS2Container.getComponent(IMessageProviderUtil.class);//インタフェースの型を指定している。
	}
